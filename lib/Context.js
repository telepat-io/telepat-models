	...
	delete(callback) {
		...
		async.series([
			...
			callback1 => {
				...
				let deletedContext =  TelepatContext.contexts[id];
				delete TelepatContext.contexts[id];

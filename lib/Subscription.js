...
Subscription.add = function(appId, context, deviceId, channel, user_id, parent, extraFilters, callback) {
	var key = Subscription.getSubscriptionKey(context, deviceId, channel, user_id, parent, extraFilters);
...
Subscription.getSubscriptionKey = function(context, deviceId, channel, user_id, parent, extraFilters) {

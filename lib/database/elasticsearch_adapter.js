...
var ElasticSearchDB = function(config) {
	...
	if (validEnvVariables) {
		...
		if (process.env.TP_ES_HOSTS)
			this.config.hosts = process.env.TP_ES_HOST.split(',');
		else if (process.env.TP_ES_HOST) {
			this.config.host = process.env.TP_ES_HOST;
			this.config.port = process.env.TP_ES_PORT;
		}

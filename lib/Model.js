...
Model.search = function(channel, sort, page, callback) {
	Application.datasource.dataStorage.modelSearch(channel, sort, page, callback);
};

Model.modelCountByChannel = function(channel, aggregation, callback) {
	Application.datasource.dataStorage.modelCountByChannel(channel, aggregation, callback);
};

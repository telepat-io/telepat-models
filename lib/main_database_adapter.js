...
//Main_Database_Adapter.prototype.applicationIncrementIndex = function(delta, callback) {};
...
Main_Database_Adapter.prototype.adminGet = function(email, calllback) {};
Main_Database_Adapter.prototype.adminCreate = function(email, props, callback) {};
Main_Database_Adapter.prototype.adminUpdate = function(email, patches, callback) {};
Main_Database_Adapter.prototype.adminDelete = function(email, callback) {};
...
//Main_Database_Adapter.prototype.contextIncrementIndex = function(delta, callback) {};
...
Main_Database_Adapter.prototype.modelCountByChannel = function(channel, callback) {};
Main_Database_Adapter.prototype.modelCreate = function(modelName, appId, props, callback1) {};
//Main_Database_Adapter.prototype.modelIncrementIndex = function(modelName, appId, delta, callback) {};
Main_Database_Adapter.prototype.modelUpdate = function(modelName, appId, context, id, patch, callback) {};
Main_Database_Adapter.prototype.modelSearch = function(channel, callback) {};
Main_Database_Adapter.prototype.userGet = function(email, appId, callback) {};
Main_Database_Adapter.prototype.userGetAll = function(appId, callback) {};
...
//Main_Database_Adapter.prototype.userIncrementIndex = function(callback) {};
Main_Database_Adapter.prototype.userUpdate = function(email, appId, patch, callback) {};
Main_Database_Adapter.prototype.userDelete = function(email, appId, callback) {};

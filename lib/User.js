 ...
 * @constructor
 */
function User(_id, appId, callback) {
	Application.datasource.dataStorage.userGet(_id, appId, callback);
}
...
User.getAll = function(appId, page, callback) {
	Application.datasource.dataStorage.userGetAll(appId, page, callback);
}
